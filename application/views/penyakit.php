...
<body class="">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id="tablePenyakit" class="table table-striped table-hover">
                    ...
                    <div class="col-md-6">
                		...
                		<div class="col-md-6">
                			<div class="form-group">
                				...
                				<input type="text" name="ket_penyakit" class="form-control" placeholder="Keterangan Penyakit">
                			</div>
                		</div>
                	</div>
                </form>
  ...
  <script src="<?php echo base_url('assets/js/admina.penyakit.js'); ?>" type="text/javascript"></script>
