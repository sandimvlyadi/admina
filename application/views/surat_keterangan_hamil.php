...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="">Surat Keterangan Hamil</a>
          </div>
          ...
          <div id="table" class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="row">
                	<div class="col-6">
                		<h4 class="card-title"> Tabel Surat Keterangan Hamil</h4>
                	</div>
                	<div class="col-6">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id="tableKeteranganHamil" class="table table-striped table-hover">
                ...
                <form id="formData">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="nama_pejabat" class="form-control" placeholder="Nama Pejabat" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="alamat_pejabat" class="form-control" placeholder="Alamat Pejabat" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="date" name="tgl_periksa" class="form-control" placeholder="Tanggal Periksa" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select name="keterangan" class="form-control">
                          <option value="Hamil" selected>Hamil</option>
  ...
  <script src="<?php echo base_url('assets/js/admina.surat.keterangan.hamil.js'); ?>" type="text/javascript"></script>
