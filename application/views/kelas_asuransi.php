...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="">Kelas Asuransi</a>
          </div>
          ...
          <div id="table" class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="row">
                	<div class="col-6">
                		<h4 class="card-title"> Tabel Kelas Asuransi</h4>
                	</div>
                	<div class="col-6">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id="tableKelasAsuransi" class="table table-striped table-hover">
              ...
              <div class="card-body">
                <form id="formData">
                	<div class="row">
                		...
                		<div class="col-md-6">
                			<div class="form-group">
                				<label>Limit Biaya</label>
                				<input type="number" name="limit_biaya" class="form-control" placeholder="Limit Biaya" value="0">
                			</div>
                		</div>
                    <div class="col-md-6">
                      <div class="form-group">
  ...
  <script src="<?php echo base_url('assets/js/admina.kelas.asuransi.js'); ?>" type="text/javascript"></script>
