...
<body class="">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id="tableRole" class="table table-striped table-hover">
                ...
                <form id="formData">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Name (Capital letter with '_')</label>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select name="id_parent" class="form-control"></select>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Department</label>
                        <select name="id_dept" class="form-control"></select>
                      </div>
                    </div>
                	</div>
                </form>
  ...
  <script src="<?php echo base_url('assets/js/admina.role.js'); ?>" type="text/javascript"></script>
