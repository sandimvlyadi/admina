...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="">Pembelian</a>
          </div>
                ...
                <form id="formData">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select name="id_supplier" class="form-control"></select>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="status_pembelian" class="form-control" value="Open">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Tanggal Beli</label>
                        <input type="date" name="tgl_beli" class="form-control" placeholder="Tanggal Beli" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
  ...
  <script src="<?php echo base_url('assets/js/admina.pembelian.js'); ?>" type="text/javascript"></script>
