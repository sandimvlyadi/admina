...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="">Hari Praktek</a>
          </div>
          ...
          <div id="table" class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="row">
                	<div class="col-6">
                		<h4 class="card-title"> Tabel Hari Praktek</h4>
                	</div>
                	<div class="col-6">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id="tableHariPraktek" class="table table-striped table-hover">
                ...
                <form id="formData">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select name="hari_praktek" class="form-control">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="time" name="jam_praktek_mulai" class="form-control" placeholder="Jam Mulai" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Jam Selesai</label>
                        <input type="time" name="jam_praktek_selesai" class="form-control" placeholder="Jam Selesai" required>
                      </div>
                    </div>
                	</div>
                </form>
  ...
  <script src="<?php echo base_url('assets/js/admina.hari.praktek.js'); ?>" type="text/javascript"></script>
