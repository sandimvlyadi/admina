...
<body class="">
                ...
                <form id="formData">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="ket_satuan" class="form-control" placeholder="Keterangan">
                      </div>
                    </div>
                	</div>
                </form>
  ...
  <script src="<?php echo base_url('assets/js/admina.satuan.js'); ?>" type="text/javascript"></script>
