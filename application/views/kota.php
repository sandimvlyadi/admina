...
<body class="">
          ...
          <div id="table" class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="row">
                	<div class="col-6">
                		<h4 class="card-title"> Tabel Kota</h4>
                	</div>
                	<div class="col-6">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id="tableKota" class="table table-striped table-hover">
  ...
  <script src="<?php echo base_url('assets/js/admina.kota.js'); ?>" type="text/javascript"></script>
