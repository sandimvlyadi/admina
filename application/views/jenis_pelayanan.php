...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="">Jenis Pelayanan</a>
          </div>
          ...
          <div id="table" class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="row">
                	<div class="col-6">
                		<h4 class="card-title"> Tabel Jenis Pelayanan</h4>
                	</div>
                	<div class="col-6">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id="tableJenisPelayanan" class="table table-striped table-hover">
                	...
                	<div class="row">
                		<div class="col-md-6">
                			<div class="form-group">
                				...
                				<input type="text" name="nama_pelayanan" class="form-control" placeholder="Nama Pelayanan" required>
                			</div>
                		</div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Keterangan</label>
                        <input type="text" name="ket_pelayanan" class="form-control" placeholder="Keterangan">
                      </div>
                    </div>
                	</div>
                </form>
  ...
  <script src="<?php echo base_url('assets/js/admina.jenis.pelayanan.js'); ?>" type="text/javascript"></script>
