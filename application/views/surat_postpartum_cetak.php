			...
			<table align="center" width="100%" border="0" cellpadding="5">
				<tbody>
					...
					<tr>
						...
						<td width="80%">: <?php echo $diagnosa; ?></td>
					</tr>
					<tr>
						<td colspan="3">&nbsp;</td>
					</tr>
					...
					<tr>
						<td width="5%">&nbsp;</td>
						<td width="15%">Tanggal Kontrol</td>
						<td width="80%">: <?php echo tglIndo($tanggal_kontrol); ?></td>
					</tr>
					<tr>
						<td colspan="3">Demikian dan terima kasih.</td>
					</tr>
				</tbody>
			</table>
