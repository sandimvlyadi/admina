...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="">Surat Rujukan</a>
          </div>
          ...
          <div id="table" class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="row">
                	<div class="col-6">
                		<h4 class="card-title"> Tabel Surat Rujukan</h4>
                	</div>
                	<div class="col-6">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id="tableSuratRujukan" class="table table-striped table-hover">
                ...
                <form id="formData">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                		...
                		<div class="col-md-6">
                			<div class="form-group">
                				<label>Umur</label>
                				<input type="number" name="umur_pasien" class="form-control" placeholder="Umur" required>
                			</div>
                		</div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Alamat</label>
                        <input type="text" name="alamat_pasien" class="form-control" placeholder="Alamat" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="row">
                        <div class="col-md-4">
                          <div class="form-group">
                            <label>Gravida</label>
                            <input type="text" name="gravida" class="form-control" placeholder="Gravida" required>
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            <label>Partus</label>
                            <input type="text" name="partus" class="form-control" placeholder="Partus" required>
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            <label>Aborsi</label>
                            <input type="text" name="aborsi" class="form-control" placeholder="Aborsi" required>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="pemeriksaan_pasien" class="form-control" placeholder="Pemeriksaan Pasien" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Diagnosa</label>
                        <input type="text" name="diagnosa_pasien" class="form-control" placeholder="Diagnosa Pasien" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Tindakan</label>
                        <input type="text" name="tindakan" class="form-control" placeholder="Tindakan" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
  ...
  <script src="<?php echo base_url('assets/js/admina.surat.rujukan.js'); ?>" type="text/javascript"></script>
