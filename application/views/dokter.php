...
<body class="">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id="tableDokter" class="table table-striped table-hover">
                ...
                <form id="formData">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="spesialisasi" class="form-control" placeholder="Spesialisasi" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Alamat</label>
                        <input type="text" name="alamat_dokter" class="form-control" placeholder="Alamat" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>No. Handphone</label>
                        <input type="number" name="no_hp_dokter" class="form-control" placeholder="No. Handphone" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>E-Mail</label>
                        <input type="email" name="email_dokter" class="form-control" placeholder="E-Mail">
                      </div>
                    </div>
                		<div class="col-md-6">
                			<div class="form-group">
  ...
  <script src="<?php echo base_url('assets/js/admina.dokter.js'); ?>" type="text/javascript"></script>
