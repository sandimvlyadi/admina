...
<body class="">
            ...
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-4">
                    <label>Tanggal</label>
                    <select name="filter-tanggal" class="form-control">
                  ...
                  <div class="col-lg-4">
                    <label>Tahun</label>
                    <select name="filter-tahun" class="form-control">
          ...
          <div class="col-md-4">
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12">
                    <div class="rm-detail tanggal-kunjungan">
                      Waktu Kunjungan: 
                    </div>
                    <div class="rm-detail no-rekam-medis">
                      No. Rekam Medis: 
                    </div>
                    <div class="rm-detail nama-pasien">
                      Nama Pasien: 
                    </div>
                    <div class="rm-detail jenis-pelayanan">
                      Jenis Pelayanan: 
                    </div>
                  </div>
                  <div class="rm-detail col-md-12">
                    <div class="hasil-diagnoasa">
                      Hasil Diagnosa: 
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="table-responsive">
                      <table id="tableObat" class="table table-striped table-hover table-sm">
  ...
  <script src="<?php echo base_url('assets/js/admina.rekam.medis.js'); ?>" type="text/javascript"></script>
