...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="">Surat Hamil</a>
          </div>
          ...
          <div id="table" class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="row">
                	<div class="col-6">
                		<h4 class="card-title"> Tabel Surat Hamil</h4>
                	</div>
                	<div class="col-6">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id="tableHamil" class="table table-striped table-hover">
                ...
                <form id="formData">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="number" name="usia_kehamilan" class="form-control" placeholder="Usia Kehamilan" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
  ...
  <script src="<?php echo base_url('assets/js/admina.surat.hamil.js'); ?>" type="text/javascript"></script>
