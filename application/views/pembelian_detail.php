...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="">Pembelian Detail</a>
          </div>
          ...
          <div id="table" class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="row">
                	<div class="col-6">
                		<h4 class="card-title"> Tabel Pembelian Detail</h4>
                	</div>
                	<div class="col-6">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id="tablePembelianDetail" class="table table-striped table-hover">
                ...
                <form id="formData">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="nama_obat" class="form-control">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="number" name="qty_beli" class="form-control" placeholder="Quantiti" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Harga Beli</label>
                        <input type="number" name="harga_beli_obat" class="form-control" placeholder="Harga Beli" required>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Harga Jual</label>
                        <input type="number" name="harga_jual_obat" class="form-control" placeholder="Quantiti" required>
                      </div>
                    </div>
                	</div>
                </form>
  ...
  <script src="<?php echo base_url('assets/js/admina.pembelian.detail.js'); ?>" type="text/javascript"></script>
