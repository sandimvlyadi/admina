...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="">Data ICD</a>
          </div>
          ...
          <div id="table" class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="row">
                	<div class="col-6">
                		<h4 class="card-title"> Tabel Data ICD</h4>
                	</div>
                	<div class="col-6">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id="tableDataICD" class="table table-striped table-hover">
                	...
                	<div class="row">
                		<div class="col-md-6">
                			<div class="form-group">
                				<label>Data ICD</label>
                				<input type="text" name="data_icd" class="form-control" placeholder="Data ICD" required>
                			</div>
                		</div>
                		<div class="col-md-6">
                			<div class="form-group">
                				<label>Kode ICD</label>
                				<input type="text" name="kode_icd" class="form-control" placeholder="Kode ICD" required>
                			</div>
                		</div>
                	</div>
                </form>
  ...
  <script src="<?php echo base_url('assets/js/admina.data.icd.js'); ?>" type="text/javascript"></script>
