	...
	<tr>
		<td colspan="4">
			<table align="center" width="100%" border="0" cellpadding="5">
				...
				<tr>
					<td colspan="2" align="center">
						<h2><u>SURAT KETERANGAN LAHIR</u></h2>
						<p>No. Surat: <?php echo $no_surat; ?></p>
					</td>
				</tr>
			</table>
			...
			<table align="center" width="100%" border="0" cellpadding="5">
				<tbody>
					<tr>
						<td colspan="3">Yang bertanda tangan di bawah ini Klinik Utama Nur Khadijah, menerangkan bahwa:</td>
					</tr>
					<tr>
						<td width="5%">&nbsp;</td>
						<td width="15%">Nama</td>
