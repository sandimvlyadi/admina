...
$('#li-kota').addClass('active');

$(document).ready(function(){
	table = $('#tableKota').DataTable({
		'processing'	: true,
        'serverSide'	: true,

        'ajax' : {
        	'url'	: baseurl + 'kota/datatable/',
            'type'	: 'GET',
...
$('#tableKota').on('click', 'button[name="btn_edit"]', function(){
	var id = $(this).attr('id');
	var nama = '';
	$('#tableKota tbody tr').each(function(){
...
$('#tableKota').on('click', 'button[name="btn_delete"]', function(){
