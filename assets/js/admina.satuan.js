            	...
            	if (response.result) {
            		for(var x in response.data){
	            		...
	            		row.push({
                            ...
                            'ket_satuan'    : response.data[x].ket_satuan,
	            			'aksi'          : button
	            		});
	            		i = i + 1;
	            	}
...
$('#tableSatuan').on('click', 'button[name="btn_edit"]', function(){
	var id = $(this).attr('id');
	var nama = '';
    var ket = '';
	...
	$('input[name="nama_satuan"]').val(nama);
    $('input[name="ket_satuan"]').val(ket);
...
$('#tableSatuan').on('click', 'button[name="btn_delete"]', function(){
